...
//  Whack-a-Penguin
//
//  Created by Chris Li on 9/12/19.
...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        background.position = CGPoint(x: 512, y: 384) // iPad size?
        ...
        gameScore.position = CGPoint(x: 8, y: 8) // hard coded?
        gameScore.horizontalAlignmentMode = .left
        gameScore.fontSize = 48
        addChild(gameScore)
        
        // hight y places node towards the top
        for i in 0 ..< 5 {
